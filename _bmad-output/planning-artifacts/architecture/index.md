...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Starter: create-next-app (Official)](./starter-template-evaluation.md#selected-starter-create-next-app-official)
  ...
  - [Implementation Patterns & Consistency Rules](./implementation-patterns-consistency-rules.md)
    - [잠재적 충돌 지점 (7개 영역)](./implementation-patterns-consistency-rules.md#잠재적-충돌-지점-7개-영역)
    ...
    - [Communication Patterns (Zustand)](./implementation-patterns-consistency-rules.md#communication-patterns-zustand)
